...
# C9	4.7uF	C_0402_1005Metric	13.9000	-21.5500	-90.0	top

# PCBWAY
# Designator Footprint               Mid X         Mid Y         Ref X         Ref Y         Pad X         Pad Y TB      Rotation Comment        
# R26        0603R              660.236mil   1603.937mil    660.236mil   1603.937mil    630.236mil   1603.937mil  T        360.00 RES          
    ...
    with open(orig_file) as csv_file:
        ...
        for row in csv_reader:
            ...
            if "IGNORE" not in ref:
                ...
                component['Mid X'] = str(round(float(row['PosX'][:-2]) * mm_to_mil, 3)) + "mil"
                component['Mid Y'] = str(round(float(row['PosY'][:-2]) * mm_to_mil, 3)) + "mil"
                ...
                if componentInfo['Type'] != "None":
                    ...
                    component['Footprint'] = row['Package']
